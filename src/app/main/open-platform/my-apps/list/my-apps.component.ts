...
export class MyAppsComponent implements OnInit, OnDestroy {
    ...
    initSearch() {
        this.loading.show();
        this.openCenterService.openapiReview(this.page.page, this.page.size, this.page.sort).pipe(takeUntil(this._unsubscribeAll)).subscribe(res => {
            if (res) {
                this.rows = res['body'];
    ...
    onSearch() {
        ...
        this.openCenterService.openapiReview(this.page.page, this.page.size, this.page.sort, multiSearch).pipe(takeUntil(this._unsubscribeAll)).subscribe(res => {
            if (res) {
    ...
    //         },
    //         {
    //             translate: '激活', icon: 'delete', fn: (event) => {
    //                 this.delApp(event);
    //             }
    //         }];
    // }
    ...
    getDetail(event) {
        ...
        this.router.navigate(['/open/myApps/edit/' + p]).then(res => {
            this.loading.hide();
        });
    }
