import {Component, ElementRef, OnDestroy, OnInit, ViewChild, ViewEncapsulation, NgZone} from '@angular/core';
...
@Component({
    selector: 'bigBusinessData',
    templateUrl: './big-business-data.component.html',
    styleUrls: ['./big-business-data.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations
})
export class BigBusinessDataComponent implements OnInit, OnDestroy {
    ...
    getBaseUrl() {
        this.utils.getBaseUrl().then(project => {
            ...
            this.searchMembersContributeData();
    ...
    changNumUnit(num) {
        ...
        if (num.length >= 7) {
           ...
           // const value = reg.toFixed(0);
            return reg ; // + this.translate.instant('BusinessDataAnalysis.millionYuan_');  // 万
        } else {
            return num;
        }
    }
