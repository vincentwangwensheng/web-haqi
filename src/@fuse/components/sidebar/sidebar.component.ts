...
import {NotifyAsynService} from '../../../app/services/notify-asyn.service';
...
export class FuseSidebarComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private notify: NotifyAsynService, // responsive notify
    ) {
        // Set the defaults
    ...
    set folded(value: boolean) {
        ...
        this.notify.foldChange.emit(this.folded);
    }
        ...
        this._fuseMatchMediaService.onMediaChange
            ...
            .subscribe(() => {
                ...
                if (isActive) {
                    ...
                    sessionStorage.setItem('leftMenu', JSON.stringify(this.opened));
                    this.notify.openChange.emit(this.opened);
